...
| ------------------------------------------------------------------------------- | ------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| USB drive                                                                       | ✅             | ❌      | Generic USB drive designed by germanese and produced by chinese                                                                                                             | Yield `EXFAT Volume`, yield `EXT4 Volume`                                                                     |
| EXFAT Volume                                                                    | ✅             | ❌      | 12GB volume, visible in windows, contains images and validator binaries                                                                                                     | Yield `Folder: "Source"`, yield `validator binary (target linux)`, yield `validator binary (target windows)`  |
| EXT4 Volume                                                                     | ✅             | ❌      | 4GB volume, invisible in windows, contains images, public and private keys                                                                                                  | Yield `Private Key`, yield `Public Key "bayron@cordano"`, yield `Folder: "KeyPass"`, yield `Folder: "Remote"` |
| Validator C# Windows (target: `windows`)                                        | ❌             | ❌      | Built for windows in C#. If `ADA` environment variable is set to `Lovelace` calculates filehash, compares it to filename and deems file "Valid" based on comparison results | Used to validate files in an unknown workflow                                                                 |
| Validator C# Linux (target: `.net`)                                             | ❌             | ❌      | Built for linux in C#. If `ADA` environment variable is set to `Lovelace` calculates filehash, compares it to filename and deems file "Valid" based on comparison results   | Used to validate files in an unknown workflow                                                                 |
| Folder: `Source`                                                                | ❌             | ❌      | Folder containing original 27 images with filename equal to filehash                                                                                                        | Yield `Private key Password "Cardano"`                                                                        |
| Private Key                                                                     | ✅             | ❌      | Openssh private key used to connect to a remote machine                                                                                                                     | Yield `Publick key "serj@GWS-HOME"`                                                                           |
| Public Key `bayron@cordano`                                                     | ✅             | ❌      | Public key, derivated from private, with, supposedly, manually changed user@host field                                                                                      | ❔                                                                                                             |
| Folder: `KeyPass`                                                               | ✅             | ❌      | Contains 7 identic images to the ones from `Source` with slight derivation (1 hex byte) in name                                                                             | Yield Password `Cardano`                                                                                      |
| Public Key `serj@GWS-HOME`                                                      | ❌             | ❔      | Public key, derivated from private using password `Cardano`                                                                                                                 | ❔                                                                                                             |
| Username `serj`                                                                 | ❌             | ❌      | Supposedly, Byron's username                                                                                                                                                | Yield `Remote Username`                                                                                       |
| Hostname `GWS-HOME`                                                             | ❌             | ❌      | Supposedly, Byron's hostname                                                                                                                                                | Yield `Remote Hostname`                                                                                       |
| Folder: `Remote`                                                                | ✅             | ❌      | Indexed images with hex byte difference                                                                                                                                     | Yield `Cardano Node IP`                                                                                       |
| 125.251.180.194                                                                 | ✅             | ✅      | Cardano node IP Serj connected to                                                                                                                                           | Yield Location `Korea`                                                                                        |
