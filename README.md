...
| EXT4 Volume                                                                    | ✅             | ❌      | 4GB volume, invisible in windows, contains images and validator binaries                                                                                                   | Yield `Folder: "Source"`, yield `validator binary (target linux)`, yield `validator binary (target windows)` |
...
| Remote                                                                          | ✅             | ❌      | Indexed images with hex byte difference                                                                                                                                   | Yield `Cardano Node IP`                                                                                      |
