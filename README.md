...
| EXFAT Volume                                                                    | ✅             | ❌      | 12GB volume, visible in windows, contains images and validator binaries                                                                                                   | Yeild `Folder: "Source"`, yeild `validator binary (target linux)`, yeild `validator binary (target windows)` |
